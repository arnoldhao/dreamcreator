...
import "dreamcreator/internal/domain/settings"
...
func Menu(lang settings.Language) MenuStrings {
	...
	default:
		return MenuStrings{
			AppTitle:          "DreamCreator",
			About:             "About DreamCreator",
			Settings:          "Settings...",
			CheckingForUpdate: "Checking for update…",
			InstallUpdate:     "Install updates",
			Hide:              "Hide DreamCreator",
			HideOthers:        "Hide Others",
			ShowAll:           "Show All",
			Quit:              "Quit DreamCreator",
			File:              "File",
			Edit:              "Edit",
			Undo:              "Undo",
			Redo:              "Redo",
