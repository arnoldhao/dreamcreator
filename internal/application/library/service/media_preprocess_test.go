...
func TestResolveFFprobeExecPathUsesExternalToolsOnly(t *testing.T) {
	t.Parallel()
...
func TestResolveFFprobeExecPathRequiresExternalToolReadiness(t *testing.T) {
	t.Parallel()
...
func (stub *mediaProbeToolResolverStub) ResolveExecPath(context.Context, externaltools.ToolName) (string, error) {
	if stub.err != nil {
		return "", stub.err
	}
...
func (stub *mediaProbeToolResolverStub) ResolveToolDirectory(context.Context, externaltools.ToolName) (string, error) {
	if stub.err != nil {
		return "", stub.err
	}
...
func (stub *mediaProbeToolResolverStub) ToolReadiness(context.Context, externaltools.ToolName) (bool, string, error) {
	if stub.err != nil {
