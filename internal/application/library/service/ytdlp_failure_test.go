...
func (stub *ytdlpFailureToolResolverStub) ResolveExecPath(_ context.Context, _ externaltools.ToolName) (string, error) {
	if stub.execPath == "" {
...
func (stub *ytdlpFailureToolResolverStub) ResolveToolDirectory(_ context.Context, _ externaltools.ToolName) (string, error) {
	if stub.execPath == "" {
		return "", fmt.Errorf("missing exec path")
	}
...
func (stub *ytdlpFailureToolResolverStub) ToolReadiness(_ context.Context, _ externaltools.ToolName) (bool, string, error) {
	if stub.execPath == "" {
