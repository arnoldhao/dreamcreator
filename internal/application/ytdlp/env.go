...
func resolveFFmpegDir(ctx context.Context, resolver ToolResolver) string {
	if resolver != nil {
		if execPath, err := resolver.ResolveExecPath(ctx, externaltools.ToolFFmpeg); err == nil {
...
func resolveBunExecPath(ctx context.Context, resolver ToolResolver) string {
	if resolver != nil {
		if execPath, err := resolver.ResolveExecPath(ctx, externaltools.ToolBun); err == nil {
