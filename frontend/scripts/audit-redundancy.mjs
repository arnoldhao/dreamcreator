...
const exportAuditFiles = [
  "frontend/src/features/library/components/library-config-shared.tsx",
  "frontend/src/features/library/components/library-config-utils.ts",
  "frontend/src/features/library/components/library-workspace-utils.ts",
];
const orphanAuditDirs = [
  "frontend/src/features/library/components",
  "frontend/src/features/settings/gateway/ui",
];
